                  ...
                  <div className="max-w-6xl mx-auto px-6 md:px-12">
                    <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-6">
                      <div className="max-w-2xl">
                        <p className="text-[#8A6820] text-[11px] font-bold tracking-[0.2em] uppercase mb-3">{t.listings.badge}</p>
                        <h2 className="font-serif text-[#0E1F3D] text-4xl md:text-5xl font-bold mb-4">{t.listings.title}</h2>
                        <p className="text-slate-600 text-lg font-light">{t.listings.desc}</p>
                      </div>
                      <div className="hidden md:flex gap-4">
                        <button className="w-12 h-12 rounded-full border border-slate-200 flex items-center justify-center text-slate-400 hover:border-[#C9A84C] hover:text-[#C9A84C] transition-all">
                          <ChevronRight className="rotate-180" size={20} />
                        </button>
                        <button className="w-12 h-12 rounded-full border border-[#0E1F3D] bg-[#0E1F3D] flex items-center justify-center text-white hover:bg-[#1A3260] transition-all">
                    ...
                    <div className="grid md:grid-cols-3 gap-8">
                      {[
                        ...
                        <div key={listing.id} className="group bg-slate-50 rounded-[2rem] overflow-hidden border border-slate-100 hover:shadow-2xl hover:shadow-[#0E1F3D]/5 transition-all duration-500">
                          <div className="relative h-64 overflow-hidden">
                            ...
                            <div className="absolute top-4 left-4 bg-[#C9A84C] text-[#0E1F3D] px-4 py-1.5 rounded-full text-xs font-bold shadow-lg">
                              {listing.price}
                            </div>
                            <button 
                              onClick={() => {
                              ...
                              className="absolute top-4 right-4 w-10 h-10 bg-white/90 backdrop-blur-sm rounded-full flex items-center justify-center text-[#0E1F3D] hover:bg-[#C9A84C] hover:text-white transition-all shadow-lg"
                          ...
                          <div className="p-8">
                            <div className="flex items-center gap-2 text-slate-400 mb-2">
                              <MapPin size={14} />
                              <span className="text-xs uppercase tracking-widest font-bold">{listing.location}</span>
                            </div>
                            <h3 className="font-serif text-[#0E1F3D] text-xl font-bold mb-6">{listing.title}</h3>
                            <div className="flex items-center justify-between py-4 border-t border-slate-200">
                              <div className="flex flex-col items-center">
                                <span className="text-[#0E1F3D] font-bold">{listing.beds}</span>
                                <span className="text-slate-400 text-[10px] uppercase font-bold tracking-widest">Beds</span>
                              </div>
                              <div className="w-px h-8 bg-slate-200" />
                              <div className="flex flex-col items-center">
                                <span className="text-[#0E1F3D] font-bold">{listing.baths}</span>
                                <span className="text-slate-400 text-[10px] uppercase font-bold tracking-widest">Baths</span>
                              </div>
                              <div className="w-px h-8 bg-slate-200" />
                              <div className="flex flex-col items-center">
                                <span className="text-[#0E1F3D] font-bold">{listing.sqft}</span>
                                <span className="text-slate-400 text-[10px] uppercase font-bold tracking-widest">{t.listings.sqft}</span>
                              </div>
                            </div>
                            <button className="w-full mt-6 bg-white border border-[#0E1F3D] text-[#0E1F3D] hover:bg-[#0E1F3D] hover:text-white py-3 rounded-xl font-bold text-sm transition-all flex items-center justify-center gap-2">
